...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("sistemas@crosstronik.com.ec"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->IsSMTP(); 
    $mail->Host = "ssl://smtp.webfaction.com:465";  // Servidor de Salida. 465 es uno de los puertos que usa Google para su servidor SMTP
    $mail->SMTPAuth = true; 
    $mail->Username = "sistemas_1";  // Correo Electrónico
    $mail->Password = "Sistemas##12"; // Contraseña del correo
