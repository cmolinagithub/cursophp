...
<body>
  <h3>Pagina de consulta con PHP - PDO</br> EJEMPLO CONSULTAS PREPARADAS</h3>
    <?php
    $buscar=$_GET["buscar"];
    try {
        ...
        , visita_tecnica, descripcion_evento, tecnico_ctk, codigo_cliente FROM ctk_ticket where tecnico_ctk=?";
