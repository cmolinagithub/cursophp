...
if (isset($_POST["phpmailer"])) {
    ...
    $mail->Username = "cmolinabastidas@gmail.com";
    $mail->Password = "##0401573100##";

    $mail->From = "cmolinabastidas@yahoo.com";

    $mail->FromName = "Carlos Molina";
    ...
    if ($mail->Send()) {
        ...
        $msg = "Lo siento, ha habido un error" . $mail->ErrorInfo . "al enviar el mensaje a $email";
    }
}
?>
