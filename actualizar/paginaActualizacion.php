...
p { color: black; font-family: Verdana; }
    ...
    <body>
<h3>REGISTROS PARA ACTUALIZAR </h3>
<?php
$buscar=$_GET["buscar"];
echo  "Este es el parametro se busqueda $buscar";
//$buscar='cmolina';
require 'datos_conexion.php';
//require 'ejecutarActualizacion.php';
...
{
    echo"<form action='ejecutarActualizacion.php' method='get'>";
    echo "<tr>";
 
         echo "<td> <input type='text' name='codigo' readonly='readonly' value='". $columna['codigo_ticket']."'></td>";
