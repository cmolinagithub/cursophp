...
<html lang="es">
    ...
    <body>
        ...
        */
        ...
        $ok=mysqli_stmt_bind_param($resultado,'ssssssisssssss', $codigo_ticket, $abierto_por, $fecha_apertura,
           $hora_apertura, $fecha_cierre, $hora_cierre, $visita_tecnica, $descripcion_evento, $tipo,
            $factura, $observacion, $tecnico_ctk, $codigo_cliente, $adicional);
