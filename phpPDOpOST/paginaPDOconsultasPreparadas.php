...
<body>
  <h3>Pagina de consulta con PHP - PDO</br> EJEMPLO CONSULTAS PREPARADAS Y METODO POST</h3>
    <?php
    $buscar=$_POST["buscar"];
    try {
        ...
        , visita_tecnica, descripcion_evento, tecnico_ctk, codigo_cliente FROM ctk_tickettt where tecnico_ctk=?";
