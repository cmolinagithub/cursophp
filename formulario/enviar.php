...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("cmolinabastidas@yahoo.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "carlos_molina";  // Correo Electrónico
    $mail->Password = "Carlos##12"; // Contraseña del correo
